    ...
    <header className={classes.join(" ")}>
      <div id="headerInner" className={styles.headerInner}>
        <div className={styles.logoNav}>
          <Link to="/">
            <img src={logo} alt="Tomoko Kawaguchi portfolio home" />
          </Link>
        ...
        {/* Mobile menu */}
        <button id={styles.mobileMenuButton} onClick={handleClick} aria-label="Toggle menu" aria-expanded={isMobileActive} aria-controls="mobileMenu">
          <span id={styles.mobileMenuText}>Menu</span>
          <div id={styles.hamburgerMenu} aria-hidden="true">
            <div className={styles.bar}></div>
            <div className={styles.bar}></div>
          </div>
        </button>

        <div id="mobileMenu" className={styles.mobileMenuWrapper} role="dialog" aria-label="Mobile navigation menu">
